...
public class ModItems {
    ...
    public static final RegistryObject<Item> GRAPE_VINES = ITEMS.register("", () -> new BlockItem(ModBlocks.GRAPE_VINES.get(), new Item.Properties().tab(BREAD_REBORN_TAB).stacksTo(64)));
    public static final RegistryObject<Item> BLOOMING_GRAPE_VINES = ITEMS.register("", () -> new BlockItem(ModBlocks.BLOOMING_GRAPE_VINES.get(), new Item.Properties().tab(BREAD_REBORN_TAB).stacksTo(64)));
